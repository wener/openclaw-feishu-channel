...
import type { FeishuPluginAccountConfig } from "./plugin-config.js";
...
export type ResolvedFeishuAccount = {
  ...
  botOpenId?: string;  // Bot 的 open_id，用于路由时构造@提及
  domain: FeishuDomain;
  isRouter?: boolean;
  /** Merged config (top-level defaults + account-specific overrides) */
  config: FeishuConfig;
  /** Plugin-level config (botOpenId, isRouter, senderMentionKey, routeMap) */
  pluginConfig?: FeishuPluginAccountConfig;
};
